...
public class DB_10 extends JDialog implements ActionListener{
	JTextField t1;
	JTextField t2;
	JButton b1;
	JButton b2;
	...
	public DB_10(){
		...
		//input data for searching type
		t1 = new JTextField(50);
		t1.setText("Search Type");	
		...
		//table made by data
		String colNames[] = {"TYPE", "NAME", "CALL", "ADDRESS", "FLOOR","STATION", "OPEN","CLOSE","BREAK","EVALUATION","BUSINESS_ID"};
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource() == b1){
			...
			try {
				...
				rs = stmt.executeQuery("select * from dbcourse_typeview where type = '"+ t1.getText()+"' order by name");
